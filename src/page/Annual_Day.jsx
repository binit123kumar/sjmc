...
import Image100 from '../asset/Our gallery/Annual_Day/1.jpeg';
import Image101 from '../asset/Our gallery/Annual_Day/7.jpeg';
import Image102 from '../asset/Our gallery/Annual_Day/2.jpeg';
import Image103 from '../asset/Our gallery/Annual_Day/3.jpeg';
import Image104 from '../asset/Our gallery/Annual_Day/4.jpeg';
import Image105 from '../asset/Our gallery/Annual_Day/5.jpeg';
import Image106 from '../asset/Our gallery/Annual_Day/6.jpeg';

function Annual_Day() {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const images = [
    { src: Image100, date: '19 March 2026' },
    { src: Image101, date: '19 March 2026' },
    { src: Image102, date: '19 March 2026' },
    { src: Image103, date: '19 March 2026' },
    { src: Image104, date: '19 March 2026' },
     { src: Image105,date: '19 March 2026' },
    { src: Image106, date: '19 March 2026' },
  ];
      ...
      <div className="container">
        <div className="p-4 mx-auto text-center" style={styles.card}>
          <h2 className="mb-4 fw-bold text-primary">
              Gyan Ka Chashma<br /><small>19 March 2026</small>
          </h2>
            ...
            {images.map((img, i) => (
              <div key={i} className="col-6 col-md-4 mb-3">
                ...
                >
                  ...
                  <div className="overlay" style={styles.overlay}> Gyan Ka Chashma | 19 March 2026</div>
                </div>
              </div>
            ))}
          </div>
